%QT_ROOT%\bin\moc.exe TinQTConsole.h  > TinQTConsoleMoc.cpp
%QT_ROOT%\bin\moc.exe TinQTSourceWin.h  > TinQTSourceWinMoc.cpp
%QT_ROOT%\bin\moc.exe TinQTBreakpointsWin.h  > TinQTBreakpointsWinMoc.cpp
...
%QT_ROOT%\bin\moc.exe TinQTSchedulesWin.h  > TinQTSchedulesWinMoc.cpp
